const abi = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "string", name: "_hostedBy", type: "string" },
  ...
  },
  {
    inputs: [
      { internalType: "uint256", name: "_eventID", type: "uint256" },
      { internalType: "uint256", name: "_matchID", type: "uint256" },
      { internalType: "string", name: "_side1", type: "string" },
      { internalType: "string", name: "_side2", type: "string" },
  ...
  },
  {
    ...
    name: "declareWinnerAndDistribute",
    outputs: [],
    stateMutability: "payable",
    type: "function",
  },
  {
    ...
    outputs: [
      ...
      { internalType: "string", name: "hostedBy", type: "string" },
    ...
    outputs: [
      {
        ...
        internalType: "struct BettingDapp.Bettor[]",
        name: "",
        type: "tuple[]",
      },
    ],
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "string", name: "uid", type: "string" },
          {
            components: [
              ...
              { internalType: "string", name: "side1", type: "string" },
              { internalType: "string", name: "side2", type: "string" },
              ...
              { internalType: "string", name: "status", type: "string" },
              { internalType: "bool", name: "resultAnnounced", type: "bool" },
              { internalType: "uint256", name: "winnerID", type: "uint256" },
              { internalType: "uint256", name: "funds1", type: "uint256" },
              { internalType: "uint256", name: "funds2", type: "uint256" },
              { internalType: "uint256", name: "totalFunds", type: "uint256" },
            ],
            internalType: "struct BettingDapp.Match[]",
            name: "matches",
            type: "tuple[]",
          },
        ...
        internalType: "struct BettingDapp.Event[]",
        name: "",
        type: "tuple[]",
      },
    ],
